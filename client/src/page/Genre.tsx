            ...
            <Container>
                <Row style={{ marginTop: "15px" }}>
                    <Col md={{ span: 6, offset: 4 }} style={{ display: "flex" }}>
                        <Button href='/genre/One-day' style={{ marginRight: "15px", border: "2px solid black",  borderRadius:"1.5rem", backgroundColor:"rgb(29, 63, 92)"}}>ทัวร์ภูเก็ต One Day Trip</Button>
                        <Button href='/genre/Many-day' style = {{border: "2px solid black",  borderRadius:"1.5rem",  backgroundColor:"rgb(29, 63, 92)"}}>ทัวร์ภูเก็ตพร้อมที่พัก</Button>
                    </Col>
                </Row>
